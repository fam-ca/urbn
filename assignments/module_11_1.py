...
###################################################
'''
Библиотека requests предоставляет возможность работать с запросами с веб-сайтов
в удобном формате

Библиотека numpy предоаставляет возможность работы с массивами. выполнять различные
математические операции

Библиотека matplotlib предоставляет возможность работы с визулизацией данных в 2D и 3D.
